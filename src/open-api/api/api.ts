...
export const APIS = [AuthService, CategoryService, CommentService, DashboardService, FeatureConfigService, GroupsService, NotificationsService, PromptService, ReceiptService, ReceiptImageService, SearchService, SystemEmailService, SystemTaskService, TagService, UserService, UserPreferencesService];
