...
export class UserPreferencesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUserPreferences(userPreferences: UserPreferences, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<UserPreferences>;
    public updateUserPreferences(userPreferences: UserPreferences, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<UserPreferences>>;
    public updateUserPreferences(userPreferences: UserPreferences, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<UserPreferences>>;
