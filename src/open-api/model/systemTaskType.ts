...
export type SystemTaskType = 'META_ASSOCIATE_TASKS_TO_RECEIPT' | 'OCR_PROCESSING' | 'CHAT_COMPLETION' | 'MAGIC_FILL' | 'QUICK_SCAN' | 'EMAIL_READ' | 'META_COMBINE_QUICK_SCAN' | 'EMAIL_UPLOAD' | 'SYSTEM_EMAIL_CONNECTIVITY_CHECK' | 'RECEIPT_PROCESSING_SETTINGS_CONNECTIVITY_CHECK' | 'RECEIPT_UPLOADED' | 'RECEIPT_UPDATED' | 'PROMPT_GENERATED';
